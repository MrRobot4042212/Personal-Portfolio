...
export function Header() {
    ...
    return(
        <header>            
            <section>
                <img className="hd-avatar" src="/portfolio/public/img/avatar-bio-2.jpg" alt="" />
            </section>
            <aside>
