            ...
            <div className="pin-wrap">
                  ...
                  <section className='mi-me-section' datatype='biografia'>
                    ...
                    <div className='content-wrap'>
                      ...
                      <span>
                        <img className='mi-img-row' src="public/img/avatar-bio.jpg" alt="" />
                      </span>
                    </div>
                  </section>
                  <section className='mi-me-section' datatype='experiencia'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                          <li datatype='indra'>
                          <img className='text-wrap-icon' src="public/img/icons/indra.jpg" alt="" />
                          ...
                          <img className='text-wrap-icon' src="public/img/icons/infibail.png" alt="" />
                  ...
                  <section className='mi-me-section' datatype='educacion'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                          <li>
                          <img className='text-wrap-icon' src="public/img/icons/UEM.png" alt="" />
                          ...
                          <li>
                          <img className='text-wrap-icon' src="public/img/icons/SMA.png" alt="" />
                  ...
                  <section className='mi-me-section' datatype='cursos'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                      <li>
                          <img className='text-wrap-icon' src="public/img/icons/hardvard.png" alt="" />
                          <h2>CS50's Introduction to computer science
                          </h2>
                          <h4>19/05/2024 – Actualmente<br/>Harvard University. Instructor: David J. Malan</h4>
                      </li>
                      <li>
                          <img className='text-wrap-icon' src="public/img/icons/cisco.png" alt="" />
      ...
      <ul className='proyect-container mi-flexZoom'>
        ...
        <li className="li-container">
          <section className='flexZoom-container'>
              <UlBoxes
                LiImg="public/img/proyectos/EHN.png"
                ...
                icons={[
                  ...
                  {
                    url: "public/utils/Grupo05_Memoria_ElHamitiNews.pdf",
                    socialName: "Memoria",
              ...
              />
              <UlBoxes
                LiImg="public/img/proyectos/maraboo.png"
              ...
              />
              <UlBoxes
                LiImg="public/img/proyectos/logo.png"
                LiTittle="PowerPulse"
              ...
              />
              <UlBoxes
                LiImg="public/img/proyectos/FNC.png"
