            ...
            <div className="pin-wrap">
                  ...
                  <section className='mi-me-section' datatype='biografia'>
                    ...
                    <div className='content-wrap'>
                      ...
                      <span>
                        <img className='mi-img-row' src="img/avatar-bio.jpg" alt="" />
                      </span>
                    </div>
                  </section>
                  <section className='mi-me-section' datatype='experiencia'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                          <li datatype='indra'>
                          <img className='text-wrap-icon' src="img/icons/indra.jpg" alt="" />
                          ...
                          <img className='text-wrap-icon' src="img/icons/infibail.png" alt="" />
                  ...
                  <section className='mi-me-section' datatype='educacion'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                          <li>
                          <img className='text-wrap-icon' src="img/icons/UEM.png" alt="" />
                          ...
                          <li>
                          <img className='text-wrap-icon' src="img/icons/SMA.png" alt="" />
                  ...
                  <section className='mi-me-section' datatype='cursos'>
                    ...
                    <div className='content-wrap'>
                      <ul className='mi-text-wrap-container'>
                      <li>
                          <img className='text-wrap-icon' src="img/icons/hardvard.png" alt="" />
          ...
          <section className='flexZoom-container'>
              <UlBoxes
                ...
                icons={[
                  ...
                  {
                    url: "utils/Grupo05_Memoria_ElHamitiNews.pdf",
                    socialName: "Memoria",
